...
const days = [
  // ---------------- TOKIO ----------------
  {
    ...
    stops: [
      ...
      { name: 'Hoppy Street', kind: 'visit' },
      { name: 'Puente Azuma', kind: 'visit' },
      { name: 'Sumida', kind: 'visit', durOverride: 20, note: 'Vistas del Skytree desde el parque, sin subir — decidimos que no merecía la pena por el precio y por ir de noche (brillos en el cristal); ya se ve Tokio desde arriba en el avión.', transit: 'Metro Tobu/Toei Oshiage → hotel, 1 parada o 15 min andando.', transitMin: 15 },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Shibuya Sky', kind: 'visit', durOverride: 60, note: 'Justo encima de la estación de Shibuya — reservad hora con antelación online, se agotan franjas los fines de semana.' },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Palacio Imperial de Kioto (Gosho)', kind: 'visit', durOverride: 30, note: 'También con reserva previa en la Agencia de la Casa Imperial, igual que el Sento — a unos minutos andando dentro del mismo parque.', transit: '5-10 min andando dentro del Parque Imperial.', transitMin: 8 },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Magic Cafe & Bar Shinsekai', kind: 'meal', mealType: 'lunch', durOverride: 45, transit: 'Metro Midosuji/Tanimachi de vuelta al hotel, ~20-25 min.', transitMin: 25 },
      { name: 'Hotel Osaka', kind: 'visit', durOverride: 460, note: 'Tarde libre — maletas con calma, descanso, alguna compra de última hora. Salid hacia el aeropuerto sobre las 19:30-20:00.', transit: 'Metro/tren a la estación + Nankai "Rapi:t" o JR Kansai Airport Line a Kansai Airport (~40-45 min).', transitMin: 55 },
