...
const days = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Castillo Nijō', kind: 'visit', durOverride: 75, note: 'El suelo "uguisubari" (de ruiseñor) chirría al pisarlo — un sistema antiguo para detectar intrusos.', transit: 'Metro Tozai Line Nijōjō-mae → Marutamachi (~10 min) + 5 min andando al Parque Imperial.', transitMin: 15 },
      { name: 'Palacio Imperial Sento de Kioto', kind: 'visit', durOverride: 30, note: 'Se visita solo con reserva/tour guiado — comprobad horarios si queréis entrar, el jardín exterior se ve igualmente desde el parque.' },
      { name: 'Santuario Shirakumo', kind: 'visit', durOverride: 15 },
      { name: 'Munakata Shrine', kind: 'visit', durOverride: 15 },
      { name: 'Santuario Itsukushima (interior del Parque del Palacio Imperial de Kioto)', kind: 'visit', durOverride: 15, mealAfter: 'dinner', note: 'Una réplica en miniatura del santuario de Miyajima que visitaréis más adelante — con su propio torii sobre un estanque.', transit: 'Metro Karasuma Line Marutamachi → Shijo, ~5 min.', transitMin: 10 },
      { name: 'Hotel Kyoto', kind: 'info' },
    ],
  },
  // ---------------- KIOTO ----------------
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Mirokuin Temple', kind: 'visit', durOverride: 15, note: 'Templo tranquilo y poco visitado, justo al lado de Ginkaku-ji.' },
      ...
      { name: 'Nanzen-ji', kind: 'visit', durOverride: 45, transit: 'Bus Kioto City Bus Nanzenji-michi → Shijo Karasuma, ~20-25 min.', transitMin: 25 },
  ...
  },
  {
    ...
    stops: [
      { name: 'Hotel Kyoto', kind: 'meal', mealType: 'breakfast', durOverride: 30, note: 'Desayuno en el hotel, con maletas listas.', transit: 'Maletas en consigna de la estación de Kioto + Metro Tozai Line (vía Karasuma-Oike) a Daigo, ~35 min en total.', transitMin: 35 },
      {
        ...
        transit: 'Metro Tozai Line Daigo → Kioto (~25 min) + JR Nara Line a Uji, ~20 min.', transitMin: 45,
      },
      {
        name: 'Byōdō-in', kind: 'visit', durOverride: 45,
        note: 'El pabellón Phoenix (Hōō-dō) es el edificio que aparece en la moneda de 10 yenes.',
        transit: 'JR Nara Line Uji → Nara, ~25 min.', transitMin: 25,
      },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Castillo de Hiroshima', kind: 'visit', durOverride: 45, transit: '10 min andando al Jardín Shukkeien.', transitMin: 10 },
      { name: 'Jardín Shukkeien', kind: 'visit', durOverride: 30, note: 'Jardín paisajista de 1620, inspirado en el Lago del Oeste de Hangzhou — muy cerca del hipocentro, sirvió de refugio tras la bomba atómica.', transit: 'Tranvía Hiroden desde la parada más cercana → Hatchōbori, ~10 min en total.', transitMin: 15 },
  ...
  },
  {
    ...
    kind: 'city', dayStartTime: '08:00',
    travelNote: 'Salida del hotel con equipaje por la mañana (dejar maletas en consigna de la estación). Vuelo OSAKA KANSAI 23:20 → Singapur 05:00 (+1) — al ser el último día, toda la ruta de hoy es dentro de Osaka, sin trenes de larga distancia. Haciendo todo el recorrido llegaríais al aeropuerto sobre las 20:48 (~2h30 de margen); para llegar a las 3h completas de margen que dan tranquilidad con el Tax Free y el control de pasaportes, saltaos alguno de los opcionales marcados abajo (Umeda Sky, Takimikoji, Kuromon Market, America-mura, Tower Slider, Magic Cafe & Bar Shinsekai) — con uno solo que os saltéis ya sobra.',
    stops: [
      ...
      { name: 'Umeda Sky Building (osaka)', kind: 'visit', durOverride: 45, optional: true, note: 'Opcional — de los primeros en saltarse si vais justos de tiempo para el vuelo.' },
      { name: 'Takimikoji', kind: 'visit', durOverride: 20, optional: true, note: 'Opcional — callejón para un tentempié (takoyaki, okonomiyaki, kushiage) justo al lado del Umeda Sky Building.', transit: 'Metro Midosuji Line Umeda → Namba (~10 min) + andar/metro a Kuromon (~10 min).', transitMin: 20 },
      { name: 'Kuromon Market', kind: 'visit', durOverride: 45, optional: true, mealAfter: 'lunch', note: 'Opcional como parada en sí — si se salta, comed en cualquier sitio de Shinsaibashi/Dōtonbori más adelante.' },
      { name: 'Shinsaibashisuji', kind: 'visit', durOverride: 30 },
      { name: 'America-mura', kind: 'visit', durOverride: 30, optional: true, note: 'Opcional — de los primeros en saltarse si vais justos de tiempo.' },
      ...
      { name: 'Tower Slider (Tsutenkaku)', kind: 'visit', durOverride: 30, optional: true, note: 'Opcional — de los primeros en saltarse si vais justos de tiempo.' },
      { name: 'Magic Cafe & Bar Shinsekai', kind: 'visit', durOverride: 45, optional: true, note: 'Opcional — mejor saltarlo que llegar con prisas al vuelo.', transit: 'Metro Sakaisuji/Midosuji a Namba (~10 min) + Nankai "Rapi:t" o JR Kansai Airport Line a Kansai Airport (~40-45 min).', transitMin: 60 },
