...
const days = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Adashino Nenbutsuji Temple', kind: 'visit', durOverride: 30, transit: 'JR Sagano Line Saga-Arashiyama → Kioto Station (~15-20 min) + bus/metro al hotel (~10 min).', transitMin: 30 },
      { name: 'Hotel Kyoto', kind: 'info' },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Sanjusangendomawari', kind: 'visit', durOverride: 60, mealAfter: 'lunch', transit: 'Bus o taxi hasta Ginkaku-ji, ~25-35 min.', transitMin: 30 },
      { name: 'Ginkaku-ji', kind: 'visit', durOverride: 60 },
      ...
      { name: 'Nanzen-ji', kind: 'visit', durOverride: 45 },
      { name: 'Templo Eikando', kind: 'visit', durOverride: 45, transit: 'Bus Kioto City Bus Eikando-michi → Shijo Karasuma, ~20-25 min.', transitMin: 25 },
      { name: 'Hotel Kyoto', kind: 'info', mealAfter: 'dinner' },
    ],
  },
  {
